...
🌐 Live Demo
Frontend: http://18.232.96.171:5174
API Base URL: https://f59moopdx0.execute-api.us-east-1.amazonaws.com
...
Dashboard Loading: React app fetches offers from DynamoDB via API Gateway
Empty State Handling: Shows helpful message when no offers exist
Sample Data Creation: One-click button to populate the database
Real-time Updates: Frontend automatically refreshes to show new data
API Integration: All operations go through serverless Lambda functions
